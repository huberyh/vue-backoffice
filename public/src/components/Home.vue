<template>
    <el-row class="panel">
        ...
        <el-col :span="24" class="panel-top">
            <el-col :span="20">
                <span class="logo-txt">INN Management</span>
            </el-col>
            <el-col :span="4">
        ...
        <el-col :span="24" class="panel-center">
            ...
            <aside class="left-aside">
                ...
                <el-menu :default-active="$route.path" :default-openeds="openedArr" class="aside-menu" @open="handleopen" @close="handleclose" @select="handleselect" theme="dark" unique-opened router>
                    <!--通过循环构造右侧菜单-->
